...
const TeamInfo: React.FC<{ oppTeam: Team; playerTeam: string, disabledScrimmageRequests: boolean }> = ({
  oppTeam,
  playerTeam,
  disabledScrimmageRequests,
}) => {
...
const Scrimmages: NextPage = ({
  ...
  return (
    <UserLayout>
      ...
      {CurrentTeamSearch && (
        <TeamInfo oppTeam={CurrentTeamSearch} playerTeam={userTeam} disabledScrimmageRequests={disabledScrimmageRequests} />
      )}
      <Card>
        <Card.Body>
